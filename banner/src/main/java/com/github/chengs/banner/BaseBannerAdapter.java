...
import com.github.chengs.banner.animation.*;
...
public abstract class BaseBannerAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    /**
     * Same as BannerAdapter#BannerAdapter(Context,int) but with
     * some initialization data.
     *
     * @param layoutResId The layout resource id of each item.
     * @param data        A new list is created out of this one to avoid mutable list
     */
    public BaseBannerAdapter(@LayoutRes int layoutResId, @Nullable List<T> data) {
    ...
    public BaseBannerAdapter(@Nullable List<T> data) {
        this(0, data);
    }

    public BaseBannerAdapter(@LayoutRes int layoutResId) {
    ...
    public void setOnItemClick(View v, int position) {
        getOnItemClickListener().onItemClick(BaseBannerAdapter.this, v, position);
    }
    ...
    public boolean setOnItemLongClick(View v, int position) {
        return getOnItemLongClickListener().onItemLongClick(BaseBannerAdapter.this, v, position);
    }
    ...
    public interface OnItemChildClickListener {
         ...
         */
        void onItemChildClick(BaseBannerAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemChildLongClickListener {
         ...
         * click and held
         *
         * @param adapter  this BaseBannerAdapter adapter
         * @param view     The childView whihin the itemView that was clicked and held.
         * @param position The position of the view int the adapter
         * @return true if the callback consumed the long click ,false otherwise
         */
        boolean onItemChildLongClick(BaseBannerAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         * @return true if the callback consumed the long click ,false otherwise
         */
        boolean onItemLongClick(BaseBannerAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(BaseBannerAdapter adapter, View view, int position);
    }
